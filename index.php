...
<head>
	...
	<script>
		...
		function animateDiv(){
			...
			$('.logo').animate({ top: newq[0], left: newq[1] }, function(){
			  animateDiv();        
			});
...
<body class="login">
	...
	<div class="logo">
		<!-- PUT YOUR LOGO HERE -->
		<h3 class="form-title" style="color:white;"><b><i>Tweet A Complaint</i></b></h3>
		<img src="assets/img/twittericon.png" height="50px" width="50px">
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<p align="center" style="<?php if($_REQUEST['status']=='Registered Successfully' || $_REQUEST['status']=='Password reset link sent to your email') echo 'color:green'; else echo 'color:red';?>"><?php echo $status;?></p>
		<form class="form-vertical login-form" action="authenticate.php" method="post">
			...
			<div class="forgot-password">
				<p>Forgot Password
					<a href="forgotpassword.php" id="forgot-btn">Click Here</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		...
		<form class="form-vertical register-form" action="authenticate.php" method="post">
